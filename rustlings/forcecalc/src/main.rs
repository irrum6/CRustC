...
fn main() {
    ...
    let value:f32 = match args[1].as_ref(){
        "force" => force(op1,op2),
        "forceN" =>force_libre_newtons(op1,false),
        "forcelb"=>force_libre_newtons(op1,true),
        "energy"=>energy(op1,op2),
        "energyJ"=>pound_foot_jouls(op1,false),
        "energyLFT"=>pound_foot_jouls(op1,true),
        "mass"=>mass(op1,op2),
        "acceleration"=>acceleration(op1,op2),
        "pounds"=>pound_kg(op1,false),
        "kilos"=>pound_kg(op1,true),
        "meters"=>foot_meter(op1,false),
        "foots"=>foot_meter(op1,true),
        _ => 0.0,//defaultness
    };
